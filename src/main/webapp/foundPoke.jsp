...
<div class="relative z-10 w-full">
                ...
                <div class="flex items-center w-full absolute top-0 left-0 bg-black opacity-80 shadow-lg shadow-[#04f6ea]">
                    ...
                    <div class="w-5/6 flex items-center gap-5">
                        ...
                        <a href="\SpiritPokemon\Pokedex.jsp" class="text-md text-white">Pokedex</a>
                        <!--  <a href="\#" class="text-md text-white"></a> -->
                        <a href="\SpiritPokemon\MySpiritPokemon.jsp" class="text-md text-white">Spirit Pokemon</a>
            	...
            	<%
            		String poke = (String)session.getAttribute("PokeName");
            		if(poke==null) poke = "spirit. You're so unique that we couldn't suggest a pokemon for you. Have some suggestion for us? Feel free to drop an email!"; 
            	%>
            
            <div class="text-2xl text-center text-white">
            	You are a wonderful <% out.println(poke); %>!
            </div>
            <div class="text-3xl text-center text-white my-5">
            	Get Immersed in a World of Pokemons and find your Spirit!!!<br><br>
            	Roam around in a free land and EXPLORE!!
            </div>
