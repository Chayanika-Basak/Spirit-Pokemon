...
<div class='bg-[#267f8f] rounded-lg w-2/5 right-align shadow-[#267f8f] shadow-md'>
	<div class='my-6'><h1 class='text-center text-3xl orbitron'>Sign Up</h1></div>
	<form method='post' action='SignUp' class='text-center text-xl mb-6'>
	  <label for="name" class='orbitron'>Name: </label>
	  	<input type="text" id="name" name="name" class='rounded-md h-12 comfortaa'><br><br>
	  <label for="age" class='orbitron'>Age: </label>
	  	<input type="number" id="age" name="age" class='rounded-md h-12 comfortaa'><br><br>
	  <label for="email" class='orbitron'>Email: </label>
	  	<input type="email" id="email" name="email" class='rounded-md h-12 comfortaa'><br><br>
	  <label for="Password" class='mb-6 orbitron'>Password: </label>
	  	<input type="password" id="password" name="password" class='mb-6 rounded-md h-12 comfortaa'><br><br>
	  <label for="country" class='mb-6 orbitron'>Country: </label>
	  	<input type="text" id="country" name="country" class='mb-6 rounded-md h-12 comfortaa'><br>
	  <input type='submit' value='Sign Up' class='mb-6 rounded-md h-12 orbitron rounded-lg bg-[#115c00] px-4 text-white hover:bg-white hover:text-black'>
	</form>
</div>
</body>
</html>