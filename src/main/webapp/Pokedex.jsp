...
<div class='bg-[#267f8f] rounded-lg w-2/5 right-align shadow-[#267f8f] shadow-md'>
	...
	<form method='get' action='Pokedex' class='text-center text-xl mb-6'>
	  <label for="name" class='orbitron'>Name </label>
	  <input type="text" id="name" name="name" class='rounded-md h-12 comfortaa'><br><br><br>
	  <input type='submit' value='Find Pokemon' class='mb-6 rounded-md h-12 orbitron rounded-lg bg-[#115c00] px-4 text-white hover:bg-white hover:text-black'>
	</form>
</div>
</body>
</html>